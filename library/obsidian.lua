...
do
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        local function Round2(Value)
            local a = math.floor(Value/Info.Rounding + (math.sign(Value) * 0.5)) * Info.Rounding
            if a < 0 then
                a = a + Info.Rounding
            end
        
            local DecimalPlaces = 0
            if Info.Rounding < 1 then
                local s = tostring(Info.Rounding)
            ...
            return tonumber(string.format("%." .. DecimalPlaces .. "f", a))
        end
        ...
        Bar.MouseButton1Down:Connect(function()
            ...
            while UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch) do
                ...
                Slider.Value = Round2(Slider.Min + ((Slider.Max - Slider.Min) * Scale))
